...
## ⚙️ Τεχνική Αρχιτεκτονική (offline-first)
...
### 1️⃣ MoodleBox Core (Raspberry Pi 5) — ο κεντρικός κορμός
...
### 2️⃣ ESP32-only Station — σταθμός άσκησης με άμεση ανατροφοδότηση
...
### 3️⃣ Pi Zero Kiosk — σταθμός οπτικών οδηγιών & troubleshooting
